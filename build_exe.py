...
def build_linux():
    ...
    args = [
        ...
        '--noconfirm',
        '--paths=src',
        f'--add-data=src/ghosttrackerpro/web/static{os.pathsep}ghosttrackerpro/web/static',
        f'--add-data=src/ghosttrackerpro/web/templates{os.pathsep}ghosttrackerpro/web/templates',
        '--hidden-import=ghosttrackerpro',
        '--hidden-import=ghosttrackerpro.core',
        '--hidden-import=ghosttrackerpro.cli',
        '--hidden-import=ghosttrackerpro.app',
